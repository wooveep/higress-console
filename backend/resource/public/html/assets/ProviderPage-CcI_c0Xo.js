import{P as M}from"./PageSection-D-HHqHRX.js";import{L as O}from"./ListToolbar-VmvkvBl2.js";import{D as F}from"./DrawerFooter-CDFY_IDw.js";import{_ as z}from"./DeleteConfirmModal.vue_vue_type_script_setup_true_lang-DjJiZmkt.js";import{d as L,o as d,e as C,f as c,t as P,v as b,B as h,w as s,i as N,y as U,r as p,C as B,_ as A,D as G,g as a,H as Y,J as H,E as q,j as Q,s as I}from"./index-B3mS5kCQ.js";import{g as W,u as X,a as Z,d as ee}from"./llm-provider-BDEaupot.js";import{s as te,j as ae,a as oe,b as ne}from"./portal-BklEkoUq.js";import{_ as se,a as le}from"./index-DIDmu7AH.js";import{F as ie,_ as re}from"./index-C95ajhzp.js";import{I as ue,a as pe}from"./index-xr-BbSHS.js";import{_ as me}from"./index-DSDgy3v-.js";import"./hasIn-bEUyXsFW.js";import"./useFlexGapSupport-BS_Av7iN.js";const ve={class:"secret-mask-text"},_e=L({__name:"SecretMaskText",props:{value:{}},setup(w){const l=w,r=p(!1),y=B(()=>l.value||"-"),m=B(()=>!l.value||r.value?y.value:l.value.length<=6?`${l.value.slice(0,1)}******`:`${l.value.slice(0,3)}******${l.value.slice(-3)}`);return(f,i)=>{const v=h;return d(),C("span",ve,[c("span",null,P(m.value),1),w.value?(d(),b(v,{key:0,type:"link",size:"small",class:"secret-mask-text__toggle",onClick:i[0]||(i[0]=n=>r.value=!r.value)},{default:s(()=>[N(P(r.value?"隐藏":"显示"),1)]),_:1})):U("",!0)])}}}),de=A(_e,[["__scopeId","data-v-b61bdab0"]]),fe={class:"provider-page__tokens"},ce={key:0},ye=`常用 rawConfigs 字段：
